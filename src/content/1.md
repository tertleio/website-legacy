...
<!-- # 15 Questions to Ask a Potential Co-Founder -->
...
mind here is to be consistent, so it's easier to accurately compare
and contrast the answers later. Feel free to cherry pick or reframe the
questions as you see fit.

You'll notice there is no skills section as I'll be following up with
a blog post dedicated to just that.
...
_Co-founder questions template:_
[view](https://docs.google.com/spreadsheets/d/1HSkSQr46yV36uMU2iJVmuwtyRkIBvocjeLkC0fODqr0/edit?usp=sharing") or
